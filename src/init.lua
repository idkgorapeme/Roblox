...
env.BrainrotPolice.globals = {
    ...
    "DBCollect", "DBUpgrade", "DBRebirth", "SBPump", "SBUpgrade", "SBLaunch", "SBFuel", "MNLock", "MNMerge", "SSWin", "SSRebirth", "KEWin1", "KEWin2", "KEDestroy", "KECoins", "KEBuy", "KSWalk", "KSBuy", "KSWin", "KSDestroy", "SWSell", "SWRebirth", "SWCollect", "WMRebirth", "WMPrestige", "WMPlaytime", "BBTrajectory", "BBHighlight", "MMCoins", "MMCoinEsp", "BFFarm", "BFSpy", "JHJump", "JHRebirth", "MPTrain", "MPWin", "MPRebirth", "MPDumbbell", "MERebirth", "MEWin", "FBGuards", "FBFarm", "FBFall", "FBRebirth", "FBSpeed", "MMMyRole"
}
